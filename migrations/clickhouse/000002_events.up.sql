-- 000002_events.up.sql
-- spacebox.begin_block_events definition

--CREATE TABLE spacebox.begin_block_events
--(
--    `height` Int64,
--    `type` String,
--    `attributes` String
...
--
---- spacebox.begin_block_events_writer source
--
--CREATE MATERIALIZED VIEW spacebox.begin_block_events_writer TO spacebox.begin_block_events
--(
--    `height` Int64,
--    `type` String,
--    `attributes` String
...
--    SELECT
--        height,
--        JSONExtractString(arrayJoin(JSONExtractArrayRaw(JSONExtractString(begin_block_events))),
-- 'type') AS type,
--        JSONExtractString(arrayJoin(JSONExtractArrayRaw(JSONExtractString(begin_block_events))),
...
-- spacebox.end_block_events definition

--CREATE TABLE spacebox.end_block_events
--(
--    `height` Int64,
--    `type` String,
--    `attributes` String
...
--SETTINGS index_granularity = 8192;
--
---- spacebox.end_block_events_writer source
--
--CREATE MATERIALIZED VIEW spacebox.end_block_events_writer TO spacebox.end_block_events
--(
--    `height` Int64,
--    `type` String,
--    `attributes` String
...
--    SELECT
--        height,
--        JSONExtractString(arrayJoin(JSONExtractArrayRaw(JSONExtractString(end_block_events))),
-- 'type') AS type,
--        JSONExtractString(arrayJoin(JSONExtractArrayRaw(JSONExtractString(end_block_events))),
-- 'attributes') AS attributes
--    FROM spacebox.raw_block_results
...
-- spacebox.txs_events definition
